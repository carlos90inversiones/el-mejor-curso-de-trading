...
<h3><div style="display:flex;justify-content:center;margin:20px 0"><svg width="420" height="100" viewBox="0 0 420 100" style="background:#131722;border-radius:10px;border:1px solid #2a2a40"><text x="210" y="16" fill="white" font-size="10" text-anchor="middle" font-weight="bold">RECUPERACIÓN DE DRAWDOWN: La Matemática Cruel</text><rect x="8" y="28" width="75" height="40" rx="5" fill="#26a69a15" stroke="#26a69a"/><text x="45" y="42" fill="#26a69a" font-size="8" text-anchor="middle" font-weight="bold">-10%</text><text x="45" y="56" fill="#787b86" font-size="6" text-anchor="middle">Necesitas +11%</text><rect x="90" y="28" width="75" height="40" rx="5" fill="#f59e0b15" stroke="#f59e0b"/><text x="127" y="42" fill="#f59e0b" font-size="8" text-anchor="middle" font-weight="bold">-25%</text><text x="127" y="56" fill="#787b86" font-size="6" text-anchor="middle">Necesitas +33%</text><rect x="172" y="28" width="75" height="40" rx="5" fill="#ef535015" stroke="#ef5350"/><text x="209" y="42" fill="#ef5350" font-size="8" text-anchor="middle" font-weight="bold">-50%</text><text x="209" y="56" fill="#ef5350" font-size="6" text-anchor="middle">Necesitas +100%</text><rect x="254" y="28" width="75" height="40" rx="5" fill="#ef535020" stroke="#ef5350"/><text x="291" y="42" fill="#ef5350" font-size="8" text-anchor="middle" font-weight="bold">-75%</text><text x="291" y="56" fill="#ef5350" font-size="6" text-anchor="middle">Necesitas +300%</text><rect x="336" y="28" width="75" height="40" rx="5" fill="#ef535030" stroke="#ef5350"/><text x="373" y="42" fill="#ef5350" font-size="8" text-anchor="middle" font-weight="bold">-90%</text><text x="373" y="56" fill="#ef5350" font-size="6" text-anchor="middle">Necesitas +900%</text><text x="210" y="85" fill="#ef5350" font-size="9" text-anchor="middle" font-weight="bold">Por eso el 1-2% de riesgo es OBLIGATORIO. Prevenir > recuperar.</text></svg></div>
REGLA #1: Nunca arriesgues más del 1-2% por operación</h3>
