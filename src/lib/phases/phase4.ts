...
<p>Imagina el oceano. Los peces pequenos (traders retail) nadan juntos en bancos, buscando seguridad en los números. Ponen sus stop loss en los mismos sitios obvios: debajo del último mínimo, encima del último máximo. Los tiburones (instituciones, bancos, fondos) lo saben perfectamente. <strong>No pueden simplemente "comprar" o "vender" como tu y yo</strong>. Necesitan mover millones, y para eso necesitan que haya ordenes del otro lado. Los stop loss de los peces pequenos SON esas ordenes. El tiburon mueve el precio hacia donde estan los peces, se los come (activa sus stops), y DESPUES mueve el mercado en la dirección real.</p>
</div>

<h3>Que es la Liquidez en Trading</h3>
<p>La <strong>liquidez</strong> es la disponibilidad de ordenes pendientes en el mercado a diferentes niveles de precio. En términos simples: es <strong>donde esta el dinero esperando ser ejecutado</strong>. Las instituciones necesitan liquidez para llenar sus ordenes masivas sin mover el precio demasiado en su contra.</p>

<div class="highlight-box green">
<h4>Concepto Clave: Por que las Instituciones Necesitan tu Stop Loss</h4>
<p>Un fondo de cobertura quiere comprar EUR/USD con una posición de 500 millones de dólares. Si simplemente pone una orden de mercado, el precio se moveria 50 pips en su contra antes de llenar toda la orden. En cambio, necesita encontrar vendedores dispuestos a venderle a buenos precios. Donde estan esos vendedores? <strong>En los stop loss de los traders retail que estan en LONG</strong>. Un stop loss de un LONG es una orden de VENTA. Exactamente lo que la institucion necesita para comprar.</p>
</div>
...
<text x="125" y="156" fill="#ef5350" font-size="7" text-anchor="middle">Stop Loss de retail aquí abajo</text>
...
<p>Cuando el precio crea dos o más maximos al mismo nivel (equal highs), cada trader retail del mundo ve una "resistencia fuerte" y pone su stop loss justo por encima. Lo mismo con equal lows: ven un "soporte fuerte" y ponen su stop justo debajo.</p>
...
<p>Dos o más maximos en el mismo nivel crean un <strong>pool de BSL</strong> encima. El mercado los ve como resistencia. En realidad, son un iman de liquidez. <strong>Espera que el precio los barra antes de buscar shorts.</strong></p>
</div>
<div class="card">
<h4>Equal Lows = SSL</h4>
<p>Dos o más minimos en el mismo nivel crean un <strong>pool de SSL</strong> debajo. El mercado los ve como soporte. En realidad, son un iman de liquidez. <strong>Espera que el precio los barra antes de buscar longs.</strong></p>
</div>
</div>
...
<ol>
<li><strong>Identifica el pool de liquidez:</strong> Equal highs, equal lows, maximos/minimos de sesión anteriores, maximos/minimos de la semana anterior</li>
...
<li><strong>Confirmacion:</strong> La siguiente vela muestra movimiento fuerte en la dirección opuesta al sweep</li>
<li><strong>Entrada:</strong> Entra en la dirección del reverso despues de que la liquidez ha sido tomada</li>
</ol>
</div>
...
<p>Liquidez semanal. Movimientos más grandes y significativos. Ideal para swing trading con Smart Money.</p>
</div>
<div class="card">
<h4>Session Highs/Lows</h4>
<p>Los maximos y minimos de la sesión asiatica son frecuentemente barridos durante London. Es uno de los setups más consistentes de ICT.</p>
</div>
<div class="card">
<h4>Swing Points Obvios</h4>
<p>Cualquier máximo o mínimo que sea obvio y visible en el gráfico acumula liquidez. Cuanto más obvio, más liquidez acumula, y más probable es que sea barrido.</p>
</div>
</div>

<div class="warning-box">
<h4>El Error Mas Comun de los Retail</h4>
<p>Los traders retail ponen su stop loss 5-10 pips por debajo del "soporte" o por encima de la "resistencia" porque eso dice el libro de texto. LAS INSTITUCIONES LO SABEN. Por eso el precio SIEMPRE parece "tocar tu stop y luego ir a tu favor". No es mala suerte, es el mercado tomando tu liquidez. La solucion: <strong>espera a que la liquidez sea tomada PRIMERO, y luego entra en la dirección del movimiento real</strong>.</p>
</div>
...
<p><strong>Paso 2:</strong> Durante la sesión de London, el precio baja agresivamente y rompe 1.2700, llegando a 1.2685.</p>
...
<p><strong>Paso 5:</strong> TP en la BSL más cercana: los maximos de ayer en 1.2780.</p>
          ...
          quiz: [
            {
              ...
              options: [
                ...
                "Solo en niveles de números redondos"
              ],
              correctIndex: 1,
            ...
            },
            {
              ...
              options: [
                ...
                "La interna es más importante que la externa",
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation: "Las instituciones manejan posiciones de cientos de millones de dólares. Necesitan contrapartes para ejecutar esas ordenes. Los stop loss de los retail son ordenes del lado opuesto que las instituciones usan para llenar sus posiciones a buenos precios."
            }
          ],
...
<p>Un <strong>Order Block (OB)</strong> es la última vela bajista antes de un movimiento alcista fuerte, o la última vela alcista antes de un movimiento bajista fuerte. Representa la zona donde las instituciones colocaron sus ordenes de forma agresiva antes de impulsar el precio en una dirección.</p>

<div class="highlight-box green">
<h4>Por que los Order Blocks Funcionan</h4>
<p>Las instituciones no pueden llenar todas sus ordenes de una sola vez. Colocan una parte de su posición, mueven el precio, y luego NECESITAN que el precio vuelva a esa zona para llenar el resto de su posición. Es por esto que el precio tiende a volver a los Order Blocks: <strong>hay ordenes institucionales pendientes esperando ser ejecutadas</strong>.</p>
</div>
...
<text x="270" y="118" fill="#2962ff" font-size="10" font-weight="bold">← ORDER BLOCK (última roja antes del impulso)</text>
...
<p>Es la <strong>última vela BAJISTA (roja)</strong> antes de un movimiento alcista impulsivo que rompe estructura. La zona del cuerpo de esa vela (de apertura a cierre) es donde las instituciones acumularon sus compras. Cuando el precio retrocede a esta zona, es una oportunidad de LONG.</p>
<p><strong>Identificacion:</strong></p>
<ol>
<li>Busca un movimiento alcista fuerte que rompa un máximo de estructura</li>
...
<p>Es la <strong>última vela ALCISTA (verde)</strong> antes de un movimiento bajista impulsivo que rompe estructura. La zona del cuerpo de esa vela es donde las instituciones acumularon sus ventas. Cuando el precio retrocede a esta zona, es una oportunidad de SHORT.</p>
<p><strong>Identificacion:</strong></p>
<ol>
<li>Busca un movimiento bajista fuerte que rompa un mínimo de estructura</li>
...
<ol>
<li><strong>Debe causar un Break of Structure (BOS):</strong> El movimiento que sale del OB debe romper un máximo o mínimo de estructura. Sin BOS, no es un OB válido.</li>
<li><strong>Debe dejar un Fair Value Gap (FVG):</strong> Los OBs más potentes crean un gap de valor justo, indicando agresion institucional extrema.</li>
<li><strong>Debe estar en una zona de descuento (para OB alcista) o premium (para OB bajista):</strong> Un OB alcista es más fuerte en la zona de descuento (por debajo del 50% del rango). Un OB bajista es más fuerte en la zona premium (por encima del 50%).</li>
<li><strong>No debe haber sido mitigado:</strong> Si el precio ya volvio al OB una vez, ha sido "mitigado" y pierde potencia. Los OBs frescos (sin tocar) son los más fuertes.</li>
...
<p>El precio ya regreso una vez. Parte de las ordenes institucionales ya fueron ejecutadas. Aun puede reaccionar pero con <strong>menor probabilidad</strong>. Requiere más confluencias.</p>
</div>
<div class="card">
<h4>OB Invalidado</h4>
<p>El precio cerro COMPLETAMENTE a traves del OB (no solo una mecha, sino un cierre de vela). Las ordenes institucionales han sido completamente absorbidas. <strong>Ya no es válido, no tradear.</strong></p>
</div>
</div>
...
<p><strong>Mecanica:</strong> El precio rompe un OB alcista -> eso significa que las instituciones que compraron ahi han sido derrotadas -> ahora hay "atrapados" en esa zona -> cuando el precio regrese, esos atrapados saldran (venderan) -> eso crea presión de venta = el Breaker actua como resistencia.</p>
</div>
...
<p><strong>Trade:</strong> Cuando el precio retroceda a 1.0900, busca SHORT. Los traders que compraron ahi estan "atrapados" y venderan para cortar perdidas, sumando presión bajista a tu favor.</p>
</div>
...
<ol>
<li><strong>Paso 1:</strong> Identifica el OB en tu timeframe de análisis (H1 o H4)</li>
<li><strong>Paso 2:</strong> Baja a un timeframe menor (M15 o M5)</li>
<li><strong>Paso 3:</strong> Dentro de la zona del OB de H1, busca el OB de M15/M5 más cercano al extremo</li>
...
<p><strong>6. Entrada:</strong> Long en 1.0860, SL en 1.0845 (debajo del OB refinado), TP en 1.0920 (próximo BSL).</p>
<p><strong>7. Resultado:</strong> 60 pips de ganancia con 15 pips de riesgo = 4:1 RR.</p>
</div>`,
          keyPoints: [
            "Un Order Block es la última vela bajista antes de un impulso alcista (Bullish OB) o la última vela alcista antes de un impulso bajista (Bearish OB)",
            "Un OB válido debe causar BOS, idealmente dejar FVG, estar en zona premium/discount correcta, y estar fresco (sin mitigar)",
...
<p><strong>Hora España: 02:00 - 10:00</strong></p>
...
<li>Pares de JPY, AUD y NZD son más activos</li>
...
<p><strong>Hora España: 09:00 - 18:00</strong></p>
...
<p><strong>Hora España: 14:00 - 23:00</strong></p>
...
<p><strong>Hora España: 14:00 - 18:00</strong></p>
<p><strong>Hora NY: 07:00 - 11:00</strong></p>
<p><strong>Caracteristicas:</strong></p>
<ul>
<li>MAXIMO volumen del dia</li>
<li>Los movimientos más grandes ocurren aquí</li>
...
<p>Las <strong>Killzones</strong> son ventanas de tiempo especificas DENTRO de cada sesión donde la probabilidad de movimientos institucionales es MAXIMA. No es lo mismo "sesión de London" que "London Killzone".</p>

<div class="highlight-box green">
<h4>Las Killzones Exactas de ICT (Hora de Nueva York / EST)</h4>
<ul>
<li><strong>Asian Killzone:</strong> 20:00 - 00:00 EST (02:00 - 06:00 España)</li>
<li><strong>London Killzone:</strong> 02:00 - 05:00 EST (08:00 - 11:00 España)</li>
<li><strong>New York Killzone (AM):</strong> 07:00 - 10:00 EST (13:00 - 16:00 España)</li>
<li><strong>London Close Killzone:</strong> 10:00 - 12:00 EST (16:00 - 18:00 España)</li>
</ul>
...
<p>El <strong>Power of 3</strong> (o AMD) es el patrón que las instituciones repiten CADA DIA, CADA SESION. Es la huella digital del dinero inteligente y el concepto MAS importante de ICT.</p>
...
<p><strong>Que ves en el gráfico:</strong> Un movimiento agresivo que rompe el rango de consolidacion, barre los stops, y crea un falso breakout.</p>
<p><strong>Lo que esta pasando realmente:</strong> La institucion esta tomando liquidez (activando stops) para llenar el resto de su posición masiva.</p>
</div>
<div class="concept-card">
...
<p><strong>Fase D (London 08:30-15:00 UTC):</strong> Despues de tomar la liquidez de abajo (SSL), el precio se revierte violentamente al alza. Rompe 1.0840 (barre también a los shorts), y sube hasta 1.0900. Los que compraron en 1.0805 (despues del sweep) ganan 95 pips.</p>
</div>
...
<p>El <strong>Judas Swing</strong> es el nombre que ICT le da a la fase de MANIPULACION del AMD. Se llama "Judas" porque es una traicion: el precio te engana moviendo en una dirección para luego ir en la opuesta.</p>
...
<li>Busca confirmación de reverso: CHoCH en M1-M5, OB, FVG</li>
<li>Entra en la dirección OPUESTA al Judas Swing</li>
</ol>
<p><strong>Tasa de éxito:</strong> El Judas Swing de London que barre el rango asiatico tiene una probabilidad extremadamente alta de reverso.</p>
</div>

<h3>London Barre el Rango Asiatico</h3>

<p>Uno de los setups MAS consistentes de ICT es la relación entre la sesión asiatica y London.</p>
...
<li><strong>Busca confirmación en LTF:</strong> En M5 o M1, busca un CHoCH o BOS en la dirección de tu bias despues del sweep</li>
<li><strong>Entra en el OB/FVG del LTF:</strong> Tu entrada esta en el primer OB o FVG que se forme despues de la confirmación</li>
<li><strong>TP:</strong> El extremo opuesto del rango asiatico o la siguiente liquidez externa en la dirección de tu bias</li>
</ol>
</div>
...
<div class="card">
<h4>Lunes</h4>
<p>"Dia de preparacion". El mercado establece el rango semanal. Puede ser engannoso. ICT recomienda observar más que tradear. Si tradeas, hazlo con tamano reducido.</p>
</div>
<div class="card">
...
<div class="card">
<h4>Jueves</h4>
<p>"Dia de reverso". Frecuentemente el mercado revierte el movimiento de la semana. Puede ofrecer buenas oportunidades pero requiere más cuidado.</p>
</div>
<div class="card">
<h4>Viernes</h4>
...
<p>Si NO estas operando durante las Killzones, estas jugando contra la casa. El 80% de los movimientos significativos ocurren durante las Killzones. Fuera de ellas, el movimiento es consolidacion, ruido, y manipulación sin dirección. <strong>Menos horas frente a la pantalla, mejores resultados.</strong></p>
</div>`,
          keyPoints: [
          ...
          quiz: [
            {
              ...
              options: [
                ...
                "El movimiento falso que barre liquidez en la dirección opuesta al movimiento real",
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation: "ICT considera Martes y Miercoles como los dias de maxima probabilidad. Las instituciones estan más activas estos dias y los movimientos son más predecibles. Lunes es de preparación y Viernes es de toma de beneficios."
            }
          ],
          practicalExercise: "Durante una semana completa, marca el rango asiatico (high y low) CADA DIA en EUR/USD M15. Luego observa que pasa cuando abre London: barrio el high o el low de Asia? Que paso despues del sweep? El precio continuo o revirtio? Documenta los 5 dias con capturas de pantalla y calcula: en cuantos de los 5 dias el patrón AMD fue visible? Esto te dara una comprension práctica del Power of 3."
        },
        // --------------------------------------------------------------------
...
<li><strong>El FVG esta entre el máximo de la vela 1 y el mínimo de la vela 3</strong></li>
</ol>
...
<li><strong>El FVG esta entre el mínimo de la vela 1 y el máximo de la vela 3</strong></li>
</ol>
</div>
...
<p>Un <strong>IFVG (Inversed FVG)</strong> se crea cuando el precio cierra completamente A TRAVES de un FVG con fuerza. Similar a como un OB invalidado se convierte en Breaker, un FVG atravesado se convierte en un IFVG que actua en la dirección OPUESTA.</p>
...
<p><strong>Mecanica:</strong> Los traders que tenian ordenes en ese FVG original ahora estan "atrapados" en el lado equivocado. Sus ordenes de salida (stop losses) crean presión en la dirección opuesta.</p>
</div>
...
<p><strong>Regla:</strong> Si el precio entra en un FVG y alcanza el CE (50%), la probabilidad de que el FVG sea respetado DISMINUYE. Si el precio solo toca el borde del FVG sin alcanzar el CE, la reaccion suele ser más fuerte.</p>
...
<text x="160" y="95" fill="#ef535088" font-size="8" text-anchor="middle">Vende aquí arriba</text>
<!-- Discount zone -->
...
<text x="160" y="170" fill="#26a69a88" font-size="8" text-anchor="middle">Compra aquí abajo</text>
<!-- Rule -->
...
<p>Toma el rango actual del precio (el último swing high y swing low):</p>
...
<li><strong>Order Block:</strong> Hay un OB válido y fresco en tu zona de entrada?</li>
...
<p><strong>Par:</strong> EUR/USD | <strong>Fecha:</strong> Martes (dia óptimo ICT)</p>
<p><strong>1. Bias HTF (H4):</strong> Tendencia alcista. Ultimo BOS al alza. Bias = LONG.</p>
<p><strong>2. Sesion:</strong> London Killzone (08:30 España) - Killzone activa.</p>
...
<p><strong>6. Order Block:</strong> En M15, hay un Bullish OB fresco en 1.0835-1.0845 (último cierre bajista antes de un BOS previo).</p>
...
<p>ICT tiene docenas de conceptos. NO necesitas usar TODOS en cada trade. Los traders más rentables usan 3-4 conceptos clave con maestria, no 20 conceptos a medias. Domina primero: Liquidez + OBs + FVGs + Killzones. Luego anade capas gradualmente. <strong>Simplicidad con comprension profunda siempre gana a complejidad superficial.</strong></p>
          ...
          keyPoints: [
            ...
            "Premium Zone = encima del 50% del rango (vende aquí), Discount Zone = debajo del 50% (compra aquí)",
            "La zona OTE de ICT (Fibonacci 0.618-0.786) es el punto óptimo de entrada en retrocesos",
...
<p>Un buen detective no necesita que el criminal le diga donde esta. Lee las pistas: huellas, marcas, patrones de comportamiento. El precio deja pistas EXACTAMENTE igual. Cada vela, cada mecha, cada patrón te cuenta una historia. Los indicadores son como leer el informe de otro detective: llega tarde y puede estar equivocado. El price action es como estar en la escena del crimen en tiempo real. <strong>El precio es el único indicador que NO miente y NO tiene retraso.</strong></p>
</div>
...
<ul>
<li><strong>Los indicadores son derivados del precio:</strong> TODOS los indicadores (RSI, MACD, medias moviles) se calculan A PARTIR del precio. Son el precio procesado con un retraso. Ir a la fuente original es siempre más rápido y preciso.</li>
<li><strong>Sin retraso (lag):</strong> El precio es información en TIEMPO REAL. Los indicadores siempre reaccionan DESPUES del movimiento.</li>
<li><strong>Claridad visual:</strong> Un gráfico limpio te permite ver la estructura, las zonas clave y los patrones sin distracciones.</li>
...
<p><strong>En contexto:</strong> Un bullish engulfing en una zona de demanda fresca, despues de un retroceso, es una señal de compra potente. Muestra que los compradores dominaron completamente a los vendedores.</p>
...
<li>Cuantas más veces toca, "más fuerte" (FALSO)</li>
...
<li>Cuantas más veces toca, MAS DEBIL (ordenes se agotan)</li>
...
<p><strong>6.</strong> Entrada LONG en 1.2665, SL debajo de la zona en 1.2640, TP en el último swing high 1.2750.</p>
...
<p>Imagina una orquesta sinfonica. Los 80 musicos (traders retail) tocan sus instrumentos, cada uno pensando que toma decisiones individuales. Pero hay UN director de orquesta (el Composite Man) que controla TODO: decide cuando suben los violines, cuando entran los tambores, y cuando hay silencio. El público (observadores del mercado) ve la orquesta tocar, pero no siempre ve al director. <strong>Richard Wyckoff nos enseno a VER al director</strong> analizando como se comporta el precio y el volumen juntos.</p>
</div>
...
<p><strong>Duracion:</strong> Semanas a meses. Cuanto más dura, más fuerte sera el movimiento posterior (Ley de Causa y Efecto).</p>
...
<p><strong>Que pasa:</strong> El Composite Man ya tiene su posición. Ahora permite/impulsa el precio al alza. La tendencia alcista comienza.</p>
<p><strong>Que ves:</strong></p>
<ul>
...
<p><strong>Estrategia:</strong> Comprar en retrocesos (pullbacks) a zonas de demanda/OBs. Es la fase donde más dinero se gana en LONG.</p>
</div>
<div class="concept-card">
...
<p><strong>Estrategia:</strong> Vender en pullbacks a zonas de supply. Es la fase donde más dinero se gana en SHORT.</p>
</div>
</div>
...
<p>Si esto te suena familiar, es porque el Spring de Wyckoff es EXACTAMENTE lo mismo que un <strong>liquidity sweep de Smart Money Concepts</strong>. Wyckoff lo describio hace 100 años.</p>
</div>
...
<li><strong>SOS (Sign of Strength):</strong> Movimiento alcista fuerte con volumen alto que rompe la resistencia del rango. La acumulación ha terminado.</li>
...
<p>Ambos describen el falso rompimiento que toma stops antes del movimiento real. Wyckoff lo llamo Spring hace 100 años. ICT/SMC lo llama liquidity sweep hoy.</p>
</div>
<div class="card">
...
<p>La misma idea: hay manos fuertes que mueven el mercado con un propósito. Wyckoff lo llamo Composite Man. ICT lo llama Smart Money o Institutional Players.</p>
</div>
<div class="card">
...
<p><strong>2. AR (Automatic Rally):</strong> Rebote rápido a 18,000. Sin mucho esfuerzo.</p>
...
<p><strong>5. SOS:</strong> Bitcoin rompe 18,000 con volumen fuerte. La acumulación término.</p>
          ...
          quiz: [
            ...
            },
            {
              ...
              options: [
                ...
                "El Spring es un indicador técnico y SMC es price action"
              ],
              correctIndex: 1,
              explanation: "El Spring de Wyckoff y el liquidity sweep de SMC son esencialmente el mismo concepto: un movimiento falso que rompe un nivel clave para tomar la liquidez (activar stops) antes de que el precio se mueva en la dirección real. Wyckoff lo describio hace 100 años."
            }
          ],
          practicalExercise: "Busca BTC/USD o SP500 en gráfico Diario y encuentra un ejemplo historico de un ciclo completo de Wyckoff. Marca cada evento: PS, SC, AR, ST, Spring (si existe), SOS, LPS. Verifica si el volumen confirma cada fase. Luego, traduce cada evento a terminologia SMC: donde estan los liquidity sweeps? Donde estan los BOS? Donde estan los OBs? Comprobaras que Wyckoff y SMC cuentan la misma historia."
        },
        // --------------------------------------------------------------------
...
<div style="display:flex;justify-content:center;margin:20px 0"><svg width="460" height="90" viewBox="0 0 460 90" style="background:#131722;border-radius:10px;border:1px solid #2a2a40"><text x="230" y="15" fill="white" font-size="10" text-anchor="middle" font-weight="bold">TU SISTEMA COMPLETO DE TRADING</text><rect x="8" y="28" width="65" height="35" rx="5" fill="#3b82f615" stroke="#3b82f6"/><text x="40" y="44" fill="#3b82f6" font-size="6" text-anchor="middle" font-weight="bold">TENDENCIA</text><text x="40" y="56" fill="#787b86" font-size="5" text-anchor="middle">HTF sesgo</text><text x="78" y="48" fill="#555" font-size="8">+</text><rect x="83" y="28" width="65" height="35" rx="5" fill="#26a69a15" stroke="#26a69a"/><text x="115" y="44" fill="#26a69a" font-size="6" text-anchor="middle" font-weight="bold">NIVEL</text><text x="115" y="56" fill="#787b86" font-size="5" text-anchor="middle">S/R + OB</text><text x="153" y="48" fill="#555" font-size="8">+</text><rect x="158" y="28" width="65" height="35" rx="5" fill="#8b5cf615" stroke="#8b5cf6"/><text x="190" y="44" fill="#8b5cf6" font-size="6" text-anchor="middle" font-weight="bold">CONFLUENCIA</text><text x="190" y="56" fill="#787b86" font-size="5" text-anchor="middle">FVG+Fib+KZ</text><text x="228" y="48" fill="#555" font-size="8">+</text><rect x="233" y="28" width="65" height="35" rx="5" fill="#f59e0b15" stroke="#f59e0b"/><text x="265" y="44" fill="#f59e0b" font-size="6" text-anchor="middle" font-weight="bold">CONFIRMACIÓN</text><text x="265" y="56" fill="#787b86" font-size="5" text-anchor="middle">Vela+BOS</text><text x="303" y="48" fill="#555" font-size="8">+</text><rect x="308" y="28" width="65" height="35" rx="5" fill="#ef535015" stroke="#ef5350"/><text x="340" y="44" fill="#ef5350" font-size="6" text-anchor="middle" font-weight="bold">RIESGO</text><text x="340" y="56" fill="#787b86" font-size="5" text-anchor="middle">1% SL R:R 1:2</text><text x="378" y="48" fill="#555" font-size="8">=</text><rect x="383" y="28" width="70" height="35" rx="5" fill="#26a69a20" stroke="#26a69a"/><text x="418" y="44" fill="#26a69a" font-size="7" text-anchor="middle" font-weight="bold">SETUP A+</text><text x="418" y="56" fill="#787b86" font-size="5" text-anchor="middle">Alta prob.</text><text x="230" y="80" fill="#f59e0b" font-size="8" text-anchor="middle" font-weight="bold">5+ confluencias = setup de máxima probabilidad</text></svg></div>
...
<li><strong>Ultimo BOS significativo:</strong> Si el último BOS en H4 fue alcista, tu bias es alcista.</li>
...
<p>Una vez que sabes la dirección, necesitas una ZONA específica donde buscar tu trade.</p>
...
<p><strong>Tipos de confirmación LTF:</strong></p>
<ul>
...
<p>Una vez dentro, necesitas reglas claras para gestionar la posición.</p>
<ul>
<li><strong>Stop Loss:</strong> Debajo/encima de la zona de entrada + margen (mechas). NUNCA lo muevas en contra de tu posición.</li>
...
<tr>
<td style="padding: 10px; border: 1px solid rgba(255,255,255,0.1);">Order Block válido</td>
...
<tr>
<td style="padding: 10px; border: 1px solid rgba(255,255,255,0.1);">Dia óptimo</td>
<td style="padding: 10px; border: 1px solid rgba(255,255,255,0.1);">+1</td>
...
<tr>
<td style="padding: 10px; border: 1px solid rgba(255,255,255,0.1);">RR mínimo 3:1</td>
<td style="padding: 10px; border: 1px solid rgba(255,255,255,0.1);">+1</td>
...
<li>Mi zona de entrada tiene OB/FVG/S-D válido? SI / NO</li>
<li>Estoy dentro de una Killzone? SI / NO (Cual? ________)</li>
<li>Es Martes, Miercoles o Jueves? SI / NO</li>
<li>Tengo confirmación en LTF? SI / NO (Cual? ________)</li>
<li>Mi RR es mínimo 3:1? SI / NO (Cuanto? ________)</li>
<li>Mi riesgo es máximo 1-2% del capital? SI / NO</li>
...
<li>NUNCA se mueve en contra de la posición (ampliar SL = suicidio)</li>
...
<li><strong>Retrocede 3 meses en el gráfico.</strong></li>
...
<li>Racha maxima de perdidas manejable con tu gestión de riesgo</li>
</ul>
</div>
...
<p><strong>Pre-sesión (5 min):</strong></p>
<ol>
...
<li>Captura de pantalla del trade (o del análisis del dia).</li>
...
<p><strong>Killzone:</strong> London KZ 08:45 España (+1)</p>
...
<p>El sistema PERFECTO no existe. Perderas trades. Tendras rachas negativas. Lo que separa a los profesionales de los amateurs no es tener un sistema que nunca pierde, sino tener un sistema con VENTAJA ESTADISTICA y la DISCIPLINA para ejecutarlo sin excepcion. Si tu sistema gana el 50% de las veces con un RR promedio de 3:1, despues de 100 trades tendrás una ganancia neta de 100R (50 trades x 3R - 50 trades x 1R). <strong>La consistencia mata la genialidad.</strong></p>
          ...
          keyPoints: [
            ...
            "Backtesting de mínimo 50-100 trades es OBLIGATORIO antes de usar dinero real. Win rate >45% con RR 3:1 = rentable",
            "La rutina diaria profesional incluye: análisis nocturno (10 min), pre-sesión (5 min), killzone activa (1-3 horas), y post-sesión journal (10 min)",
            "La consistencia en la ejecucion del sistema es más importante que la perfeccion del sistema en si"
          ],
          quiz: [
            {
            ...
            },
            {
              ...
              options: [
                ...
                "Imposible calcular sin más datos"
              ],
              correctIndex: 2,
...
<text x="178" y="48" fill="#26a69a" font-size="7">(la más fuerte!)</text>
...
<rect x="140" y="180" width="100" height="14" rx="3" fill="#ef535015"/><text x="190" y="191" fill="#ef5350" font-size="8" text-anchor="middle">3 ondas corrección</text>
<text x="340" y="191" fill="#fbbf24" font-size="8" text-anchor="middle">Onda 3 = la más rentable</text>
</svg>
</div>
...
<li><strong>Onda 2 NUNCA retrocede más del 100% de la onda 1</strong></li>
<li><strong>Onda 3 NUNCA es la más corta</strong> de las ondas 1, 3 y 5</li>
...
<div class="card"><h4>Onda 3</h4><p>Suele ser 1.618x o 2.618x la longitud de la onda 1. La más rentable.</p></div>
...
<div class="warning-box"><h4>Advertencia sobre Elliott Wave</h4><p>Elliott Wave es SUBJETIVO. Dos traders pueden ver conteos diferentes en el mismo gráfico. Usalo como CONTEXTO para entender donde estamos en el ciclo, no como señal de entrada directa. Combinalo con SMC/ICT para entradas precisas.</p></div>
...
<li>SIEMPRE confirma con estructura de mercado (BOS) y niveles SMC (OB, FVG)</li>
          ...
          keyPoints: [
            ...
            "Onda 3 es la más fuerte y rentable - siempre busca tradearla",
            "3 reglas inviolables: onda 2 < 100% de onda 1, onda 3 no es la más corta, onda 4 no solapa con onda 1",
...
<div style="display:flex;justify-content:center;margin:20px 0"><svg width="380" height="85" viewBox="0 0 380 85" style="background:#131722;border-radius:10px;border:1px solid #2a2a40"><text x="190" y="15" fill="white" font-size="10" text-anchor="middle" font-weight="bold">ORDER FLOW: QUIÉN MUEVE EL PRECIO</text><rect x="8" y="28" width="115" height="32" rx="6" fill="#26a69a15" stroke="#26a69a"/><text x="65" y="42" fill="#26a69a" font-size="8" text-anchor="middle" font-weight="bold">MARKET ORDERS</text><text x="65" y="54" fill="#787b86" font-size="6" text-anchor="middle">Agresivos → MUEVEN precio</text><rect x="130" y="28" width="115" height="32" rx="6" fill="#3b82f615" stroke="#3b82f6"/><text x="187" y="42" fill="#3b82f6" font-size="8" text-anchor="middle" font-weight="bold">LIMIT ORDERS</text><text x="187" y="54" fill="#787b86" font-size="6" text-anchor="middle">Pasivos → CREAN S/R</text><rect x="252" y="28" width="120" height="32" rx="6" fill="#f59e0b15" stroke="#f59e0b"/><text x="312" y="42" fill="#f59e0b" font-size="8" text-anchor="middle" font-weight="bold">DELTA = Diferencia</text><text x="312" y="54" fill="#787b86" font-size="6" text-anchor="middle">+ = alcista | - = bajista</text><text x="190" y="75" fill="#787b86" font-size="7" text-anchor="middle">Cuando agresivos superan pasivos, el precio se mueve</text></svg></div>
...
<p><strong>Bid:</strong> El precio más alto que alguien esta dispuesto a PAGAR (compradores esperando).</p>
<p><strong>Ask:</strong> El precio más bajo al que alguien esta dispuesto a VENDER (vendedores esperando).</p>
<p>La diferencia entre ambos es el <strong>spread</strong>.</p></div>
<div class="vocab-card"><h4>Libro de Ordenes (Order Book / DOM)</h4>
<p>Muestra todas las ordenes limitadas pendientes en cada nivel de precio. Te dice DONDE hay concentración de compradores y vendedores.</p>
<ul>
...
<p>La diferencia entre ordenes de compra agresivas y venta agresivas en un período.</p>
<ul>
<li><strong>Delta positivo:</strong> Mas compras agresivas = presión alcista</li>
<li><strong>Delta negativo:</strong> Mas ventas agresivas = presión bajista</li>
</ul></div>
...
<li><strong>Value Area (VA):</strong> Zona donde se tradeo el 70% del volumen. El precio tiende a volver aquí.</li>
<li><strong>High/Low Volume Nodes:</strong> Zonas de mucho/poco volumen. Poco volumen = el precio pasa rápido. Mucho volumen = el precio se queda pegado.</li>
</ul></div>
...
<div class="warning-box"><h4>Nota sobre Order Flow</h4><p>El Order Flow real requiere acceso a datos de nivel 2 (DOM/tape reading) que generalmente necesitan plataformas de pago como Sierra Chart, Bookmap o ATAS. Para Forex retail, el volumen de tick y Volume Profile de TradingView son buenas aproximaciones. El Order Flow puro es más util en futuros e indices.</p></div>`,
          keyPoints: [
            ...
            "Delta positivo = más compras = presión alcista, Delta negativo = presión bajista",
            "Volume Profile: POC es el precio con más volumen, Value Area es donde se tradeo el 70%",
...
<p>El patrón armonico más conocido. Forma una estructura XABCD con estas proporciones:</p>
<ul>
...
<li><strong>D</strong> = 127.2% - 161.8% de XA (extiende más alla de X)</li>
</ul>
<p><strong>Diferencia con Gartley:</strong> El punto D va MAS ALLA del punto X. Es un patrón más agresivo.</p></div>
...
<p><strong>Nota:</strong> El nivel 88.6% es el sello del Bat pattern. Retroceso profundo pero válido.</p></div>
...
<p><strong>Nota:</strong> La extension más extrema. D va 161.8% más alla de X. Reversiones explosivas.</p></div>
...
<li><strong>Stop Loss:</strong> Justo más alla de D (10-20 pips)</li>
...
<p>Son patrones de ALTA precision pero BAJA frecuencia. No aparecen todos los dias. Cuando aparecen con las proporciones correctas, el ratio de éxito es alto (65-75%). Pero si fuerzas un patrón donde no lo hay, perderas. Paciencia es clave.</p></div>`,
          keyPoints: [
            "4 patrones principales: Gartley, Butterfly, Bat, Crab",
            "Todos usan proporciones exactas de Fibonacci para los puntos XABCD",
            "La entrada siempre es en el punto D con SL justo más alla",
...
<li><strong>M1:</strong> Timing de entrada exacto y confirmación</li>
</ul></div>
...
<div class="card red-border"><h4>EVITAR: Asia, almuerzo europeo</h4><p>Baja volatilidad = spreads más altos + movimientos erraticos. No scalpes aquí.</p></div>
</div>
...
<li>Minimo 6 meses de práctica en demo antes de real</li>
</ul>
<p><strong>Recomendacion:</strong> Empieza con Swing Trading (mas fácil). Solo pasa a Scalping cuando domines el análisis y la psicología.</p></div>`,
          keyPoints: [
            "Scalping profesional = precision quirurgica, NO disparo rápido",
            "Requisitos: broker ECN (spread 0.0-0.5), ejecucion < 50ms, concentración total",
...
<div style="display:flex;justify-content:center;margin:20px 0"><svg width="420" height="85" viewBox="0 0 420 85" style="background:#131722;border-radius:10px;border:1px solid #2a2a40"><text x="210" y="15" fill="white" font-size="10" text-anchor="middle" font-weight="bold">MULTI-TF DEL SWING TRADER</text><rect x="8" y="28" width="95" height="32" rx="5" fill="#ef535015" stroke="#ef5350"/><text x="55" y="42" fill="#ef5350" font-size="8" text-anchor="middle" font-weight="bold">SEMANAL</text><text x="55" y="54" fill="#787b86" font-size="6" text-anchor="middle">Contexto macro</text><text x="108" y="46" fill="#555" font-size="10">→</text><rect x="115" y="28" width="95" height="32" rx="5" fill="#f59e0b15" stroke="#f59e0b"/><text x="162" y="42" fill="#f59e0b" font-size="8" text-anchor="middle" font-weight="bold">DIARIO</text><text x="162" y="54" fill="#787b86" font-size="6" text-anchor="middle">Tendencia + niveles</text><text x="215" y="46" fill="#555" font-size="10">→</text><rect x="222" y="28" width="95" height="32" rx="5" fill="#26a69a15" stroke="#26a69a"/><text x="269" y="42" fill="#26a69a" font-size="8" text-anchor="middle" font-weight="bold">H4</text><text x="269" y="54" fill="#787b86" font-size="6" text-anchor="middle">Setup + entrada</text><text x="322" y="46" fill="#555" font-size="10">→</text><rect x="329" y="28" width="83" height="32" rx="5" fill="#8b5cf615" stroke="#8b5cf6"/><text x="370" y="42" fill="#8b5cf6" font-size="8" text-anchor="middle" font-weight="bold">HOLD</text><text x="370" y="54" fill="#787b86" font-size="6" text-anchor="middle">Días a semanas</text><text x="210" y="75" fill="#26a69a" font-size="8" text-anchor="middle" font-weight="bold">Menos estrés, compatible con trabajo, mejores R:R</text></svg></div>
...
<div class="strategy-box"><h4>Workflow Diario (15 min, mañana y noche)</h4><ol>
<li><strong>Manana:</strong> Revisa si el precio se acerca a tus zonas. Si llega, busca confirmación en H4/H1.</li>
...
<div class="card"><h4>Trailing Stop Manual</h4><p>Cada vez que el precio haga un nuevo HH/HL (en LONG), mueve el SL debajo del último HL. Proteges ganancias y dejas correr.</p></div>
...
<li>Reducir tamano de posición a la mitad</li>
